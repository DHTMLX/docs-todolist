...
const SITE_NAME = 'DHTMLX To Do List Docs';
const PRODUCT_NAME = 'DHTMLX To Do List';
const PRODUCT_URL = 'https://dhtmlx.com/docs/products/dhtmlxTodo/';

function resolveType(pathname) {
    const path = (pathname || '').replace(/\/+$/, '');
    if (path === '' || path === '/todolist') return 'SoftwareApplication';
