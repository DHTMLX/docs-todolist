...
- определите языковые настройки, предоставив переводы для всех текстовых меток
...
Файлы не включают переводы меток Calendar, поэтому добавьте их самостоятельно.
:::
