...
@short: Получает данные о всех задачах и возвращает json-объект с массивом объектов задач

Маршрут обрабатывает GET-запрос к пути `/tasks`.
...
Маршрут возвращает json-объект с массивом всех объектов задач.
Пример объекта задач см. в разделе [`tasks`](api/configs/tasks_config.md). <br/> 
