...
DHTMLX To Do List는 **Svelte**와 호환됩니다. 아래 예제에서 두 기술을 함께 사용하는 방법을 보여줍니다. 완성된 프로젝트 예제는 [**GitHub 예제**](https://github.com/DHTMLX/svelte-todolist-demo)를 참조하세요.
...
![샘플 데이터와 함께 Svelte 애플리케이션에 렌더링된 DHTMLX To Do List](/img/trial_todolist.png)
