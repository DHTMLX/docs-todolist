...
title: 与 Vue 集成
description: 您可以在 DHTMLX JavaScript To Do List 库的文档中了解与 Vue 的集成方法。浏览开发者指南和 API 参考，查看代码示例和在线演示，并下载 DHTMLX To Do List 的 30 天免费试用版。
---
...
该命令会安装并执行 `create-vue`，即 **Vue** 官方项目脚手架工具。详情请参阅 [Vue.js 快速上手指南](https://vuejs.org/guide/quick-start.html#creating-a-vue-application)。
...
您也可以在 `mounted()` 中使用 [`parse()`](api/methods/parse_method.md) 方法将数据加载到 To Do List。以下示例在初始化后使用 `parse()` 加载数据：
...
![在 Vue 应用程序中渲染的带有示例数据的 DHTMLX To Do List](/img/trial_todolist.png)

在 [**GitHub**](https://github.com/DHTMLX/vue-todolist-demo) 上查看完整项目。
